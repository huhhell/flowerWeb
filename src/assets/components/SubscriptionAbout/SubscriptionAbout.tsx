...
export default function SubscriptionAbout() {
    ...
    return <div className="about">
        ...
        <div className="about__info">
            <h1 className="about__title">Flower Subscription</h1>
            <h6 className="about__subtitle">For Yourself</h6>
            <ul className='about__list'>
                <li className='about__list-item'>The perfect way to keep your home fresh and beautiful. Get a regular
            ...
            <h6 className="about__subtitle">As a Gift</h6>
            <ul className='about__list'>
                <li className='about__list-item'>Simply provide us with their address and let us take care of the rest,
                    delivering beautiful blooms straight to their doorstep at the frequency and duration of your
                    choosing.
                </li>
            </ul>
            <h6 className="about__subtitle">For Business</h6>
            <ul className='about__list'>
                <li className='about__list-item'>Is a great way to create a pleasant atmosphere and leave a good
            ...
            {/*TODO add anchor*/}
            <a href='#' className='about__explore'>Explore plans</a>
        </div>
    </div>
}